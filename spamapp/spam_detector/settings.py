...
SECRET_KEY = "django-insecure-5zl1$5*2(b97vwlpilu$3d0-07%=+#6okx$972f=+yhe^vw#q1"
...
INSTALLED_APPS = [
    ...
    'mlapp',           # Your main app
    'spam_detector',    # Your spam detection app
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Leave this empty if you are using app directories
